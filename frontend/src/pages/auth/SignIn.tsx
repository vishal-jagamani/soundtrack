    ...
    <div className=''>
      ...
      <section className='bg-background'>
        <div className='lg:grid lg:min-h-screen lg:grid-cols-12'>
          ...
          >
            <img alt='Pattern' src={PATTERN_IMAGE} className='absolute inset-0 h-full w-full object-cover' />
          </motion.aside>
          <motion.div
            variants={container}
            initial='hidden'
          ...
          >
            <div className='max-w-xl lg:max-w-3xl'>
              ...
              <h1 className='mt-6 text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl md:text-4xl'>Welcome to Soundtrack 📻</h1>
